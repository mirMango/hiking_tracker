...
class HikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hike" do
    assert_difference("Hike.count") do
      post hikes_url, params: { hike: { description: @hike.description, distance: @hike.distance, name: @hike.name } }
    end
  ...
  test "should update hike" do
    patch hike_url(@hike), params: { hike: { description: @hike.description, distance: @hike.distance, name: @hike.name } }
